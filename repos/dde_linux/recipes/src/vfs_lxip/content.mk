LIB_MK := $(addprefix lib/mk/,lxip.inc vfs_lxip.inc) \
          $(foreach SPEC,x86_32 x86_64 arm_v7 arm_v8,lib/mk/spec/$(SPEC)/lxip.mk) \
          $(foreach SPEC,x86_32 x86_64 arm_v7 arm_v8,lib/mk/spec/$(SPEC)/vfs_lxip.mk)
