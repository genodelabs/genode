...
#ifndef _INCLUDE__SPEC__VIRTIO_MMIO__VIRTIO__DEVICE_H_
#define _INCLUDE__SPEC__VIRTIO_MMIO__VIRTIO__DEVICE_H_
...
class Virtio::Device : Genode::Attached_dataspace, Genode::Mmio
{
	...
	public:
		...
		Device(Genode::Env                         &env,
			   ...
			   Genode::off_t                        io_mem_offset)
		: Attached_dataspace(env.rm(), io_mem_ds)
		, Mmio((addr_t)local_addr<void>() + io_mem_offset)
		{
...
#endif /* _INCLUDE__SPEC__VIRTIO_MMIO__VIRTIO__DEVICE_H_ */
