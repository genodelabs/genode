...
#
# XXX: Using - prevents us from make stopping the build when preparing the libc
#      multiple times but we should definitely find a better way to utilize rpcgen.
#
.x.h:
...
libc_rpc_generate: $(GEN_RPCB_FILES) $(GEN_RPCSVC_FILES)
